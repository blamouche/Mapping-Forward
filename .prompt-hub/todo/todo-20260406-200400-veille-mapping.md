...
- [ ] Filtrer les URLs hors périmètre cartographie/GIS/donnée cartographique/actualité du domaine (hors petites initiatives locales).
- [ ] Mettre à jour LIST.md avec normalisation + déduplication, puis commit/push selon les règles add-url.
- [ ] Mettre à la corbeille les emails traités.
- [ ] Mettre à jour la trace prompt-hub (todo, memory, version, releases).
