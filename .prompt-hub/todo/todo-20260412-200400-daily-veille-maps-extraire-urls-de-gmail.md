...
- `gog gmail messages search '''label:0---veille-mapping''' --include-body --json --max 50 --no-input` failed with Gmail OAuth `invalid_grant` (`Token has been expired or revoked`).
