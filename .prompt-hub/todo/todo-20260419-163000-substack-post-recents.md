...
- [x] Read `.prompt-hub/version.md`
- [x] Gather the 15 most recent articles from `README.md`
...
- Assumption: use the 15 most recent article links listed under `## Articles` in `README.md`.
